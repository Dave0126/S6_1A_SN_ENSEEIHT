...
figure('Name', 'Visage reconstruit');
subplot(1, 2, 1);
% Image à reconstruire
colormap gray;
imagesc(img);
title('Individu de test avec masque', 'FontSize', 20);
axis image;

%Image reconstruite

img(ligne_min:ligne_max,colonne_min:colonne_max) = img2(ligne_min:ligne_max,colonne_min:colonne_max);
subplot(1, 2, 2);
% Image à reconstruire
colormap gray;
imagesc(img);
